...
public class CommandCEUnregister extends CommandCE
{

	public CommandCEUnregister()
	{
		super(null, "CustomEntity를 해제합니다.", "customentity.unregister");
	}
	...
	{
		CustomEntityPacket.unregister(entityId).sendAll();
